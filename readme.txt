...
You will need a BeeLiked Account in order to be able to use the WordPress plugin. Sign up free at http://beeliked.com
...
Step 1 - Install 
a) Download the 'BeeLiked Microsite' WordPress plugin by clicking the download link below. (or search for it in WordPress and Install)
b) Login to your WordPress admin console account and find 'Plugin' in the menu. Click 'Add Plugin'
c) Upload the 'BeeLiked Microsite' plugin by clicking choose file and browsing to the saved file.
d) Click 'Install now'. 
...
a) In the Wordpress admin console browse to the page you would like to add your BeeLiked microsite to. Click 'Edit'. 
b) Click into the 'Visual Editor' for the content section of the page. 
c) A BeeLiked 'B' black and yellow icon will appear in the visual editor menu. Click on the 'B' icon.
d) A pop up will appear allowing you to paste in the URL of your 'BeeLiked Microsite' and then click Save. You will find this URL on the Embed pop up within BeeLiked. 
